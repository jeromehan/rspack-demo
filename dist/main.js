...
"./node_modules/.pnpm/countup.js@1.8.1/node_modules/countup.js/dist/countUp.min.js": function (module, exports, __webpack_require__) {
...
!function(a, t) {
    ...
    var e = function(a, t, n, e, i, r) {
        for(var o = 0, s = [
            ...
            "ms",
            "o"
        ], m = 0; m < s.length && !window.requestAnimationFrame; ++m)window.requestAnimationFrame = window[s[m] + "RequestAnimationFrame"], window.cancelAnimationFrame = window[s[m] + "CancelAnimationFrame"] || window[s[m] + "CancelRequestAnimationFrame"];
        window.requestAnimationFrame || (window.requestAnimationFrame = function(a, t) {
            var n = (new Date).getTime(), e = Math.max(0, 16 - (n - o)), i = window.setTimeout(function() {
                a(n + e);
            }, e);
            return o = n + e, i;
...
'use strict';
__webpack_require__.r(__webpack_exports__);
/* harmony import */var _answer__WEBPACK_IMPORTED_MODULE_1_ = __webpack_require__(/* ./answer */"./src/answer.js");

const CountUp = __webpack_require__(/* countup.js */"./node_modules/.pnpm/countup.js@1.8.1/node_modules/countup.js/dist/countUp.min.js");
console.log(CountUp);
function render() {
    document.getElementById('root').innerHTML = `the answer to the universe is ${_answer__WEBPACK_IMPORTED_MODULE_1_.answer}`;
}
render();
let options = {
    startVal: 20,
    ...
    numerals: [
        ...
        ' ',
        ' '
    ] // Array类型 替换从0到9对应的字，也就是自定数字字符了,数组存储
};
